public class TestLinkedNode {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("\nnode3 created! Address = " + Node.getAddress(node3) + " | Point to: " + Node.getAddress(node3.next));
        System.out.println("node4 created! Address = " + Node.getAddress(node4) + " | Point to: " + Node.getAddress(node4.next));
    }
}